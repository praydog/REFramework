...
class REClassInfo {
public:
    uint64_t bitfield1;              // 0x0000 0-16=typeid, 17-29 = unk, 30-42 = parent, 43-63 = declaring type
    uint32_t fqnHash;                // 0x0008
    uint32_t typeCRC;                // 0x000C
    char pad_0010[8];                // 0x0010
    uint32_t nameOffset;             // 0x0018
    uint32_t namespaceOffset;        // 0x001C
    ...
    char pad_0034[4];                // 0x0034
    uint32_t memberMethod;           // 0x0038
    uint32_t numMemberMethod;        // 0x003C
    uint32_t memberField;            // 0x0040
    uint32_t numMemberField;         // 0x0044
    uint32_t memberPropertyBitfield; // 0x0048 0-11 = num, rest (rsh 12) = index
    char pad_004C[4];                // 0x004C
    uint32_t interfaces;             // 0x0050
    char pad_0054[4];                // 0x0054
    uint32_t generics;               // 0x0058
    uint32_t vt;                     // 0x005C
    char pad_0060[16];               // 0x0060
    class REType* type;              // 0x0070
    class REObjectInfo* parentInfo;  // 0x0078
};                                   // Size: 0x0080
static_assert(sizeof(REClassInfo) == 0x80);
...
public:
    ...
    char pad_0002[8];              // 0x0002
    uint32_t variableIndex;        // 0x000A index into some global array...?
    uint16_t N00000839;            // 0x000E
    int16_t flags;                 // 0x0010
    uint16_t staticVariableOffset; // 0x0012 of
    char pad_0014[4];              // 0x0014
    void* function;                // 0x0018
    char pad_0020[8];              // 0x0020
};                                 // Size: 0x0028
static_assert(sizeof(StaticVariableDescriptor) == 0x28);
...
static_assert(sizeof(TypeListArray) == 0xC35000);
...
static_assert(sizeof(N0000247D) == 0x8);
...
static_assert(sizeof(N000025B3) == 0x8);
...
static_assert(sizeof(RETypeDB) == 0xB0);

class N000024AC {
public:
    char pad_0000[8]; // 0x0000
};                    // Size: 0x0008
static_assert(sizeof(N000024AC) == 0x8);

class N00002524 {
public:
    char pad_0000[8]; // 0x0000
};                    // Size: 0x0008
static_assert(sizeof(N00002524) == 0x8);

class REMethodDefinition {
public:
    uint64_t bitfield1;  // 0x0000 0-16 = declaring type, 34-39 = param count
    char pad_0008[2];    // 0x0008
    int16_t vtableIndex; // 0x000A
    uint32_t nameOffset; // 0x000C string_pool
    uint16_t flags;      // 0x0010
    uint16_t implFlags;  // 0x0012
    uint32_t params;     // 0x0014 byte pool
    void* function;      // 0x0018
};                       // Size: 0x0020
static_assert(sizeof(REMethodDefinition) == 0x20);
...
static_assert(sizeof(N0000547A) == 0x88);

class N000054D7 {
public:
    char pad_0000[136]; // 0x0000
};                      // Size: 0x0088
static_assert(sizeof(N000054D7) == 0x88);

class N000055A8 {
public:
    char pad_0000[136]; // 0x0000
};                      // Size: 0x0088
static_assert(sizeof(N000055A8) == 0x88);

class N0000562B {
public:
    char pad_0000[136]; // 0x0000
};                      // Size: 0x0088
static_assert(sizeof(N0000562B) == 0x88);

class N00005E89 {
public:
    uint16_t typeIndex; // 0x0000
    uint16_t N00005E8C; // 0x0002
    uint16_t N00005E90; // 0x0004 <M<<2 gives parent id
    char pad_0006[2];   // 0x0006
};                      // Size: 0x0008
static_assert(sizeof(N00005E89) == 0x8);
...
static_assert(sizeof(REProperty) == 0x10);

class N000072BF {
public:
    char pad_0000[8]; // 0x0000
};                    // Size: 0x0008
static_assert(sizeof(N000072BF) == 0x8);

class REMethodParamDef {
public:
