...
protected:
    ...
    static inline bool s_wine_queue_upgraded{false};
    static inline ID3D12Fence* s_wine_fence{nullptr};
    static inline UINT64 s_wine_fence_value{0};
    static inline HANDLE s_wine_fence_event{nullptr};
