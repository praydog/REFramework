...
typedef ImU64 ImTextureUserID;
typedef struct ImTextureID ImTextureID;
struct ImTextureID
{
    ImTextureUserID _TexUserID;
...
typedef enum {
    ImFontFlags_None = 0,
    ImFontFlags_LockBakedSizes = 1 << 0,
    ImFontFlags_NoLoadGlyphs = 1 << 1,
    ImFontFlags_NoLoadError = 1 << 2,
}ImFontFlags_;
struct ImFont
{
...
struct stbrp_node;
typedef struct ImVector_stbrp_node {int Size;int Capacity;stbrp_node* Data;} ImVector_stbrp_node;

typedef struct ImVector_ImFontAtlasRect {int Size;int Capacity;ImFontAtlasRect* Data;} ImVector_ImFontAtlasRect;
...
struct ImFontAtlasBuilder
{
    ...
    ImVector_ImFontAtlasRect Rects;
...
typedef ImVector<ImFontAtlasRect> ImVector_ImFontAtlasRect;
...
typedef ImVector<stbrp_node> ImVector_stbrp_node;
...
CIMGUI_API void igPopFontSize(void);
...
CIMGUI_API void igUpdateCurrentFontSize(void);
