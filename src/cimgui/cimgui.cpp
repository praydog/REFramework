...
//based on imgui.h file version "1.91.9 WIP" 19187 from Dear ImGui https://github.com/ocornut/imgui
...
CIMGUI_API ImTextureID* ImTextureID_ImTextureID_Nil(void)
{
    return IM_NEW(ImTextureID)();
}
CIMGUI_API void ImTextureID_destroy(ImTextureID* self)
{
    IM_DELETE(self);
}
CIMGUI_API ImTextureID* ImTextureID_ImTextureID_TextureUserID(ImTextureUserID tex_user_id)
{
    return IM_NEW(ImTextureID)(tex_user_id);
}
...
CIMGUI_API void igPushFont(ImFont* font,float font_size)
{
    return ImGui::PushFont(font,font_size);
}
CIMGUI_API void igPopFont()
{
    return ImGui::PopFont();
}
CIMGUI_API void igPushFontSize(float size)
{
    return ImGui::PushFontSize(size);
}
CIMGUI_API void igPopFontSize()
{
    return ImGui::PopFontSize();
}
...
CIMGUI_API void igImage(ImTextureUserID user_texture_id,const ImVec2 image_size,const ImVec2 uv0,const ImVec2 uv1)
{
    return ImGui::Image(user_texture_id,image_size,uv0,uv1);
}
CIMGUI_API void igImageWithBg(ImTextureUserID user_texture_id,const ImVec2 image_size,const ImVec2 uv0,const ImVec2 uv1,const ImVec4 bg_col,const ImVec4 tint_col)
{
    return ImGui::ImageWithBg(user_texture_id,image_size,uv0,uv1,bg_col,tint_col);
}
CIMGUI_API bool igImageButton(const char* str_id,ImTextureUserID user_texture_id,const ImVec2 image_size,const ImVec2 uv0,const ImVec2 uv1,const ImVec4 bg_col,const ImVec4 tint_col)
{
...
CIMGUI_API ImTextureUserID ImDrawCmd_GetTexUserID(ImDrawCmd* self)
{
    return self->GetTexUserID();
}
...
CIMGUI_API void ImDrawList_PushTextureID(ImDrawList* self,ImTextureUserID texture_id)
{
...
CIMGUI_API void ImDrawList_AddImage(ImDrawList* self,ImTextureUserID user_texture_id,const ImVec2 p_min,const ImVec2 p_max,const ImVec2 uv_min,const ImVec2 uv_max,ImU32 col)
{
    return self->AddImage(user_texture_id,p_min,p_max,uv_min,uv_max,col);
}
CIMGUI_API void ImDrawList_AddImageQuad(ImDrawList* self,ImTextureUserID user_texture_id,const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,const ImVec2 uv1,const ImVec2 uv2,const ImVec2 uv3,const ImVec2 uv4,ImU32 col)
{
    return self->AddImageQuad(user_texture_id,p1,p2,p3,p4,uv1,uv2,uv3,uv4,col);
}
CIMGUI_API void ImDrawList_AddImageRounded(ImDrawList* self,ImTextureUserID user_texture_id,const ImVec2 p_min,const ImVec2 p_max,const ImVec2 uv_min,const ImVec2 uv_max,ImU32 col,float rounding,ImDrawFlags flags)
{
...
CIMGUI_API void ImDrawList__SetTextureID(ImDrawList* self,ImTextureUserID texture_id)
{
...
CIMGUI_API void ImTextureData_GetTexID(ImTextureID *pOut,ImTextureData* self)
{
    *pOut = self->GetTexID();
}
CIMGUI_API ImTextureUserID ImTextureData_GetTexUserID(ImTextureData* self)
{
    return self->GetTexUserID();
}
CIMGUI_API void ImTextureData_SetTexUserID(ImTextureData* self,ImTextureUserID tex_user_id)
{
    return self->SetTexUserID(tex_user_id);
}
...
CIMGUI_API ImTextureRect* ImFontAtlas_GetCustomRectByIndex(ImFontAtlas* self,int index)
{
    return self->GetCustomRectByIndex(index);
}
CIMGUI_API void ImFontAtlas_CalcCustomRectUV(ImFontAtlas* self,const ImTextureRect* rect,ImVec2* out_uv_min,ImVec2* out_uv_max)
{
...
CIMGUI_API ImFontBaked* ImFont_GetFontBaked(ImFont* self,float font_size)
{
    return self->GetFontBaked(font_size);
}
...
CIMGUI_API void igSetCurrentFont(ImFont* font,float font_size)
{
    return ImGui::SetCurrentFont(font,font_size);
}
CIMGUI_API void igUpdateCurrentFontSize()
{
    return ImGui::UpdateCurrentFontSize();
}
...
CIMGUI_API bool igImageButtonEx(ImGuiID id,ImTextureUserID user_texture_id,const ImVec2 image_size,const ImVec2 uv0,const ImVec2 uv1,const ImVec4 bg_col,const ImVec4 tint_col,ImGuiButtonFlags flags)
{
...
CIMGUI_API void igDebugNodeTexture(ImTextureData* tex,int int_id)
{
    return ImGui::DebugNodeTexture(tex,int_id);
}
...
CIMGUI_API ImTextureData* igImFontAtlasBuildAddTexture(ImFontAtlas* atlas,int w,int h)
{
    return ImFontAtlasBuildAddTexture(atlas,w,h);
}
CIMGUI_API void igImFontAtlasBuildMakeSpace(ImFontAtlas* atlas)
{
    return ImFontAtlasBuildMakeSpace(atlas);
}
CIMGUI_API void igImFontAtlasBuildRepackTexture(ImFontAtlas* atlas,int w,int h)
{
    return ImFontAtlasBuildRepackTexture(atlas,w,h);
}
CIMGUI_API void igImFontAtlasBuildClearTexture(ImFontAtlas* atlas)
{
    return ImFontAtlasBuildClearTexture(atlas);
}
CIMGUI_API void igImFontAtlasBuildGrowTexture(ImFontAtlas* atlas,int old_w,int old_h)
{
    return ImFontAtlasBuildGrowTexture(atlas,old_w,old_h);
}
CIMGUI_API void igImFontAtlasBuildCompactTexture(ImFontAtlas* atlas)
{
    return ImFontAtlasBuildCompactTexture(atlas);
}
CIMGUI_API void igImFontAtlasBuildGetTextureSizeEstimate(ImVec2i *pOut,ImFontAtlas* atlas)
{
    *pOut = ImFontAtlasBuildGetTextureSizeEstimate(atlas);
}
CIMGUI_API void igImFontAtlasBuildReloadAll(ImFontAtlas* atlas)
{
    return ImFontAtlasBuildReloadAll(atlas);
}
CIMGUI_API void igImFontAtlasBuildReloadFont(ImFontAtlas* atlas,ImFontConfig* src)
{
    return ImFontAtlasBuildReloadFont(atlas,src);
}
CIMGUI_API bool igImFontAtlasBuildAddFont(ImFontAtlas* atlas,ImFontConfig* src)
{
    return ImFontAtlasBuildAddFont(atlas,src);
}
...
CIMGUI_API void igImFontAtlasBuildDiscardFontBakes(ImFontAtlas* atlas,ImFont* font)
{
    return ImFontAtlasBuildDiscardFontBakes(atlas,font);
}
CIMGUI_API void igImFontAtlasBuildDiscardFontSource(ImFontAtlas* atlas,ImFontConfig* src)
{
    return ImFontAtlasBuildDiscardFontSource(atlas,src);
}
CIMGUI_API ImFontBaked* igImFontAtlasBuildAddFontBaked(ImFontAtlas* atlas,ImFont* font,float font_size,ImGuiID baked_id)
{
    return ImFontAtlasBuildAddFontBaked(atlas,font,font_size,baked_id);
}
CIMGUI_API ImFontBaked* igImFontAtlasBuildGetClosestFontBakedMatch(ImFontAtlas* atlas,ImFont* font,float font_size)
{
    return ImFontAtlasBuildGetClosestFontBakedMatch(atlas,font,font_size);
}
CIMGUI_API void igImFontAtlasBuildDiscardFontBaked(ImFontAtlas* atlas,ImFont* font,ImFontBaked* baked)
{
    return ImFontAtlasBuildDiscardFontBaked(atlas,font,baked);
}
CIMGUI_API void igImFontAtlasBuildDiscardFontBakedGlyph(ImFontAtlas* atlas,ImFont* font,ImFontBaked* baked,ImFontGlyph* glyph)
{
    return ImFontAtlasBuildDiscardFontBakedGlyph(atlas,font,baked,glyph);
}
CIMGUI_API void igImFontAtlasBuildPreloadAllGlyphRanges(ImFontAtlas* atlas)
{
    return ImFontAtlasBuildPreloadAllGlyphRanges(atlas);
}
CIMGUI_API void igImFontAtlasBuildGetOversampleFactors(ImFontConfig* src,float size,int* out_oversample_h,int* out_oversample_v)
{
    return ImFontAtlasBuildGetOversampleFactors(src,size,out_oversample_h,out_oversample_v);
}
...
CIMGUI_API void igImFontAtlasBakedSetFontGlyphBitmap(ImFontAtlas* atlas,ImFontBaked* baked,ImFontConfig* src,ImFontGlyph* glyph,ImFontAtlasRect* r,const unsigned char* src_pixels,ImTextureFormat src_fmt,int src_pitch)
{
    return ImFontAtlasBakedSetFontGlyphBitmap(atlas,baked,src,glyph,r,src_pixels,src_fmt,src_pitch);
}
CIMGUI_API ImGuiID igImFontAtlasBakedGetId(ImGuiID font_id,float baked_size)
{
    return ImFontAtlasBakedGetId(font_id,baked_size);
}
...
CIMGUI_API ImFontAtlasRect* igImFontAtlasPackGetRect(ImFontAtlas* atlas,ImFontAtlasRectId id)
{
...
CIMGUI_API void igImFontAtlasUpdateNewFrame(ImFontAtlas* atlas,int frame_count)
{
    return ImFontAtlasUpdateNewFrame(atlas,frame_count);
}
...
CIMGUI_API void igImFontAtlasUpdateDrawListsTextures(ImFontAtlas* atlas,ImTextureUserID old_tex,ImTextureUserID new_tex)
{
...
CIMGUI_API bool ImGuiFreeType_DebugEditFontBuilderFlags(unsigned int* p_font_loader_flags)
{
    return ImGuiFreeType::DebugEditFontBuilderFlags(p_font_loader_flags);
}
