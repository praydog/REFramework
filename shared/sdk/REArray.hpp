...
namespace utility::re_array {
    ...
    static T* get_inline_element(::REArrayBase* container, int idx) {
        ...
        auto data = Address{ (uintptr_t)((REArrayBase*)utility::re_managed_object::get_field_ptr(container) + 1) - REManagedObject::runtime_size() };
    ...
    static T* get_ptr_element(::REArrayBase* container, int idx) {
        ...
        auto data = (T**)((uintptr_t)((REArrayBase*)utility::re_managed_object::get_field_ptr(container) + 1) - REManagedObject::runtime_size());
        return data[idx];
    }
