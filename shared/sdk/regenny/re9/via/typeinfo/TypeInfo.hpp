...
struct TypeInfo {
    ...
    uint32_t pad[2]; // 0x38
    regenny::via::typeinfo::TypeInfo* parent; // 0x40
    regenny::via::typeinfo::TypeInfo* child; // 0x48
    regenny::via::typeinfo::TypeInfo* next; // 0x50
    void* reflection; // 0x58
    regenny::tdb83::TypeDefinition* type_definition; // 0x60
}; // Size: 0x68
#pragma pack(pop)
}
