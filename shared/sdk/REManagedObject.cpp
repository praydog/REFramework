...
void REManagedObject::resolve_release() {
    ...
    constexpr std::array<std::string_view, 5> possible_patterns{
        ...
        "41 57 41 56 *[3] 41 54 56 57 *[3] 53 48 83 EC ? 48 8B 05 ? ? ? ? 48 31 E0 48 89 44 24 30 8B 41 08", // Seen in Onimusha Wots demo
    };
